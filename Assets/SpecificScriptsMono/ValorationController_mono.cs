...
public class ValorationController_mono : Task {
	...
	void Start () {
		...
		if (creativityAwardedPlayer != ValorationController_mono.PlayerNone) {
			bulb.transform.position = magnets [creativityAwardedPlayer].transform.position;
		}

		if (solidarityAwardedPlayer != ValorationController_mono.PlayerNone) {
