...
public class PlayerActivityController_mono : Task {

	public GameController_mono gameController;
	public RankingController_mono rankingController;
	...
	public LifeTestActivityController_mono lifeTestActivityController;
	public VolcanoActivityController_mono volcanoActivityController;
	public GompaLiteController_mono gompaController;
	public SchoolActivityController_mono myTurnSchoolActivityController_mono;

	public BuyForestActivityController_mono forestActivityController;
	...
	public void startPanel() {
		...
		if(gameController.masterController!=null)
		gameController.masterController.playSound(OKSound);
		if(gameController.masterController_kids!=null)
		gameController.masterController_kids.playSound(OKSound);
	...
	{	
		...
		// chain-check all activated buttons and call the appropriate sub-Task
			...
			if (button [ButtonTest].isActivated ()) { // see if button TEST is pressed
				...
				lifeTestActivityController.startLifeTestActivity (this, n, true); // start lifetest activity
...
//			} else
			...
			if (button [ButtonSchool].isActivated ()) { // see if button SCHOOL is pressed
				...
				myTurnSchoolActivityController_mono.startSchoolTask (this);
