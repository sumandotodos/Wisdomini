...
public class FGTableEditor : Editor {
	...
	public override void OnInspectorGUI() {
		...
		string[] translationList = tableRef.rosettaWrapper.rosetta.getLoadedTranslationsNames ();
		tableRef.rosettaWrapper.rosetta.selectedTranslation = EditorGUILayout.Popup (tableRef.rosettaWrapper.rosetta.selectedTranslation, translationList);
		tableRef.rosettaWrapper.rosetta.currentTranslationIndex = tableRef.rosettaWrapper.rosetta.selectedTranslation;
