...
public class RosettaEditor : Editor  {
	...
	string newDictLocale = "";
		...
		rosRef.defaultTranslation = rosRef.data [0];
		...
		newDictLocale = EditorGUILayout.TextField (newDictLocale);
		if (GUILayout.Button("Add translation", GUILayout.Width(200))) {
			rosRef.addTranslation (newDictLocale);
		}
