...
[CustomEditor(typeof(SchoolIngest_multi))]
public class SchoolIngest_multiEditor : Editor  {
	...
	public override void OnInspectorGUI() {
		...
		SchoolIngest_multi ingestRef = (SchoolIngest_multi)target;
	...
	public void parse(SchoolIngest_multi ingestRef) {
		...
		while (parser.charAtHead () == '+') {
			...
			while (parser.charAtHead () == '$') {
				...
				newStringBank.extra = "SchoolTest" + individual;
				prefab = PrefabUtility.CreateEmptyPrefab ("Assets/Prefabs/StringBanks/" + ingestRef.outputFolder + "/StringBank(SchoolTest" + individual + ").prefab");
