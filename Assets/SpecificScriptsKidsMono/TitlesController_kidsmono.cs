...
public class TitlesController_kidsmono : Task {
...
//	public RawImage titleImage;
	...
	public MasterController_kidsmono masterController;

	public GameObject bambooFrame;

	public InputField playcodeField;
...
//					}
	...
	public void playButton() {
		...
		if (!freePlay) {
				...
				if (playcodeField.text != CorrectPlayCode) {
					return;
				}


			gameController.quickSaveInfo.playcode = playcodeField.text;
