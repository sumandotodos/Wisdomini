...
public class NotMyTurnController_multi : Task {
	...
	public PlayerActivityController_multi playerController;
	public NotMySchoolController_multi notMyTurnSchoolController;
	public RankingControllerLite_multi rankingController;
	public NotMyTurnGuruActivityController_multi notMyTurnGuruController;
	public DossierControllerLite_multi dossierController;
	...
	public void voteOK() { 
		...
		++confirmPlayers;
		gameController.networkAgent.broadcast ("confirm:yes:" + gameController.localPlayerN + ":");
	...
	public void voteNO() {
		...
		gameController.networkAgent.broadcast ("confirm:no" + gameController.localPlayerN + ":");
	...
	public void schoolTest(int pl, int w) {
		...
		notMyTurnSchoolController.startNotMySchoolTask (this, w, pl);
	...
	public void guruTest(int type, int q) {
		...
		notMyTurnGuruController.startGuruActivityTask (this, type, q);
	}
