...
public class TitlesController_multiNormal : Task {
...
//	public RawImage titleImage;
	...
	public void titlesGoTask(Task w) {
		...
		GameObject.Find ("RosettaWrapper").GetComponent<RosettaWrapper> ().rosetta.setTranslation (gameController.quickSaveInfo.currentTranslation);
