...
public class LastChanceController_multi : Task {
	...
	void Update () {
		...
		if (state == 300) {
			...
			gameController.networkAgent.sendCommand ( gameController.playerList[available[randomP]].id, "summon:" + lifeTestController.Sabio + ":" + lifeTestController.Sabiduria + ":" + lifeTestController.QuestionNumber + ":" + gameController.localPlayerN + ":");
//			for (int i = 0; i < GameController_multi.MaxPlayers; ++i) {
...
//		}
	...
	public void clickOnPlayer(int p) {
		...
		gameController.networkAgent.sendCommand ( gameController.playerList[p].id, "summon:" + lifeTestController.Sabio + ":" + lifeTestController.Sabiduria + ":" + lifeTestController.QuestionNumber + ":" + gameController.localPlayerN + ":");
		remainingTime = 2.0f;
		state = 302;
	}
